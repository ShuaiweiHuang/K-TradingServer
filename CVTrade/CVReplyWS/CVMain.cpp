...
int main()
{
	...
	//Queue init.
        ReadQueueDAOConfigFile("../ini/CVReplyWS.ini", strService, nNumberOfQueueDAO, kQueueDAOWriteStartKey, kQueueDAOWriteEndKey, kQueueDAOReadStartKey, kQueueDAOReadEndKey);
