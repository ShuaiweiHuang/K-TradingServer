...
int main()
{
	...
	ReadClientConfigFile("../ini/CVPnlWS.ini", strListenPort, strHeartBeatTime, strEPIDNum);

	int nService = 0;
	printf("Reply program start\n");
	ReadConfigFile("../ini/CVPnlWS.ini", "EXCHANGE", struTSConfig);
	...
	//Queue init.
	ReadQueueDAOConfigFile("../ini/CVPnlWS.ini", strService, nNumberOfQueueDAO, kQueueDAOWriteStartKey, kQueueDAOWriteEndKey, kQueueDAOReadStartKey, kQueueDAOReadEndKey, kQueueDAOMonitorKey);
