...
int main()
{
	...
	ReadClientConfigFile("../ini/CVBYBITODB.ini", strListenPort, strHeartBeatTime, strEPIDNum);

	int nService = 0;
	printf("Quote program start\n");
	ReadConfigFile("../ini/CVBYBITODB.ini", "EXCHANGE", struTSConfig);
	...
	//Queue init.
	ReadQueueDAOConfigFile("../ini/CVBYBITODB.ini", strService, nNumberOfQueueDAO, kQueueDAOWriteStartKey, kQueueDAOWriteEndKey, kQueueDAOReadStartKey, kQueueDAOReadEndKey, kQueueDAOMonitorKey);
