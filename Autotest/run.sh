...
do
	...
	#./connect_ftx $USERID	$PASSWORD	1		1		1		$THREADEXP	A812201 	S		$IP     $PORT	;Result[0]=$?;
	#./connect_bm $USERID	$PASSWORD	1		1		1		$THREADEXP	A812003 	S		$IP     $PORT	;Result[0]=$?;
	#./connect_bn  $USERID	$PASSWORD	1		1		1		$THREADEXP	A812121 	S		$IP     $PORT	;Result[0]=$?;
	./connect_bb  $USERID	$PASSWORD	1		1		1		$THREADEXP	A812301 	S		$IP     $PORT	;Result[0]=$?;
