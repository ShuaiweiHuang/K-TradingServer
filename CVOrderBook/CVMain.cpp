...
int main()
{
	...
	ReadClientConfigFile("../ini/CVOrderBook.ini", strListenPort, strHeartBeatTime, strEPIDNum);

	int nService = 0;
	printf("OrderBook program start\n");
	ReadConfigFile("../ini/CVOrderBook.ini", "EXCHANGE", struTSConfig);
	...
	//Queue init.
	ReadQueueDAOConfigFile("../ini/CVOrderBook.ini", strService, nNumberOfQueueDAO, kQueueDAOWriteStartKey, kQueueDAOWriteEndKey, kQueueDAOReadStartKey, kQueueDAOReadEndKey, kQueueDAOMonitorKey);
