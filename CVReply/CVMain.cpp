...
int main()
{
	...
	ReadClientConfigFile("../ini/CVReply.ini", strListenPort, strHeartBeatTime, strEPIDNum);

	int nService = 0;
	ReadConfigFile("../ini/CVReply.ini", "EXCHANGE", struTSConfig);
	...
	//Queue init.
        ReadQueueDAOConfigFile("../ini/CVReply.ini", strService, nNumberOfQueueDAO, kQueueDAOWriteStartKey, kQueueDAOWriteEndKey, kQueueDAOReadStartKey, kQueueDAOReadEndKey);
