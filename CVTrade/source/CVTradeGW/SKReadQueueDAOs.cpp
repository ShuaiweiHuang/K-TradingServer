...
TTestTime& CSKReadQueueDAOs::GetOrderNumberHashTime(long lSerialNumber)
{
	int nHashNumber = lSerialNumber % AMOUNT_OF_HASH_SIZE;
	return m_OrderNumberHash[nHashNumber].test_time;
}
